...
const login = async (req, res) => {
    try {
        ...
        const user_rel = await User.findOne({ email: email }).populate('gender religion').lean();
        ...
        delete user_rel.password;
        user_rel['fullName'] = [user_rel?.first_name, user_rel?.last_name].join(' ');
...
const userLogin = async (req, res) => {
    ...
    try {
        ...
        const user_rel = await User.findOne({ email: email }).populate('gender religion').exec();
...
module.exports = { register, login, forgotPassword, resetPassword, checkCookie, logout, userLogin }
